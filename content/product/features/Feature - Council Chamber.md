...
- Conforms to: [[Standard - Planning Calibration]] — strategic conversations frame plans as hypotheses
...
- Quarterly review session → Jarvis walks through The Agenda → reviews Charter themes with director → surfaces patterns from past quarter's data → director updates two themes, removes one → conversation captured for future reference → session complete in 25 minutes.
