...
1. **Score each potential fix**
   ```
   Priority = Blast Radius × Severity × (1 / Effort)
   ```
...
3. **Estimate grade impact** — For Tier 1-2, project card/category/system improvement.
...
Expected impact: [cards, category, system]
...
(a) Provide info → builder proceeds
(b) Defer → acceptable gap for now
