...
**Trigger:** Before building a new scope, or when source material is updated.

Source Assessment → Inventory → Build. This job gates inventory.

## Procedure

1. **Identify source material** — Product source material in `content/sources/`, plus implementation code in `src/`
...
2. **Assess coverage by dimension**
   ...
   | WHERE | Ecosystem references, dependencies mentioned, cross-scope connections |
