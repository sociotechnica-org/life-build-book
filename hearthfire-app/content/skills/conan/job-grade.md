...
**Purpose:** Apply rubrics → card scores → category scores → system health.
...
4. **Compute category score** — Include 0.0 for missing cards. Apply completeness cap.

5. **Compute system grade** — Average categories. Determine rage level.

## Link Target Status

| Status | Category Grading | System Grading |
|--------|--------------|----------------|
...
| Category | Grade | Cards | Top Issue |
|----------|-------|-------|-----------|
