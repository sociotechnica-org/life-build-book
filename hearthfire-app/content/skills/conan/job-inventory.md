...
**Trigger:** New scope, source material updated, reassessment requested.

## Procedure

1. **Identify scope boundary** — Which source sections map to this scope?
...
[One section per product-specific type from reference.md → Type Taxonomy, in build order]
...
### Phase 4: Product-layer types (by dependency)
| Order | Card | Type | Depends On | Rationale |
|-------|------|------|------------|-----------|

### Phase 5: Agents/Prompts
