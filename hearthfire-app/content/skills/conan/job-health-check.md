...
1. **List current source materials** — Source material in `content/sources/`, implementation code
...
- Recently created
- One from each product-layer type category
